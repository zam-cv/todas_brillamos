...
import { i as isAbsolute, j as join, r as resolve } from './chunk-pathe.ff20891b.js';
...
${keys}`;
    ...
    configureServer(server) {
      server.ws.on("vitest:interceptor:register", (event) => {
        ...
        event.url = join$1(server.config.root, event.url);
        if (event.type === "manual") {
          ...
          if (event.type === "redirect") {
            ...
            event.redirect = join$1(server.config.root, redirectUrl.pathname);
          }
